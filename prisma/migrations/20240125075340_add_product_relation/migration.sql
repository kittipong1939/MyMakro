...
-- AddForeignKey
ALTER TABLE `Product_promotion` ADD CONSTRAINT `Product_promotion_promotion_is_fkey` FOREIGN KEY (`promotion_is`) REFERENCES `Promotion`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
